...
class BiDAFEmbedding(nn.Module):
    ...
    def __init__(self, word_vectors, hidden_size, drop_prob):
        ...
        self.hwy = BiDAFHighwayEncoder(2, hidden_size)
...
class BiDAFEmbeddingwithChar(nn.Module):
    ...
    def __init__(self, word_vectors, char_vectors,hidden_size,char_len, drop_prob):
        super(BiDAFEmbeddingwithChar, self).__init__()
...
class BiDAFHighwayEncoder(nn.Module):
    ...
    def __init__(self, num_layers, hidden_size):
        super(BiDAFHighwayEncoder, self).__init__()
...
class BiDAFRNNEncoder(nn.Module):
    ...
    def __init__(self,
                 ...
                 num_layers,
                 drop_prob=0.):
        super(BiDAFRNNEncoder, self).__init__()
        self.drop_prob = drop_prob
...
class BiDAFOutput(nn.Module):
    ...
    def __init__(self, hidden_size, drop_prob):
        ...
        self.rnn = BiDAFRNNEncoder(input_size=2 * hidden_size,
