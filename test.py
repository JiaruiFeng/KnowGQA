...
from models import BiDAF,QANet,KnowGQA,BiDAF_char
from os.path import join
from tensorboardX import SummaryWriter
from tqdm import tqdm
from ujson import load as json_load
from util import collate_fn, SQuAD,SQUADwithGraph,collate_fn_graph
...
def main(args):
    ...
    if (args.model_name == "KnowGQA"):
        record_file = vars(args)[f'{args.split}_record_file_graph']
        dataset = SQUADwithGraph(record_file, args.use_squad_v2)
