...
def get_setup_args():
    ...
    parser.add_argument('--add_knowledge_graph',
    ...
    parser.add_argument('--knowledge_edges_file',
                        type=str,
                        default="./data/knowledge_edges.json")
    ...
    parser.add_argument('--concept_limit',
                        type=int,
                        default=500,
                        help='Max number of concept node in a sub graph')
    ...
    parser.add_argument('--test_concept_limit',
                        type=int,
                        default=1200,
                        help='Max number of concept node in a sub graph at test time')
...
def get_train_args():
    ...
    parser.add_argument("--t1",
                        type=float,
                        default=0.5,
                        help="learning rate threshold 1")

    parser.add_argument("--warmup",
                        type=int,
                        default=2000,
                        help="warmup optimization step number")

    parser.add_argument("--t2",
                        type=float,
                        default=1e-3,
                        help="learning rate threshold 2")
...
def add_common_args(parser):
    ...
    parser.add_argument('--train_record_file_graph',
                        type=str,
                        default='./data/train_graph.npz')
    parser.add_argument('--dev_record_file_graph',
                        type=str,
                        default='./data/dev_graph.npz')
    parser.add_argument('--test_record_file_graph',
                        type=str,
                        default='./data/test_graph.npz')
...
def add_train_test_args(parser):
    ...
    parser.add_argument('--char_len',
                        type=int,
                        default=16,
                        help='Max length of char in each word')
    ...
    parser.add_argument('--h',
                        type=int,
                        default=8,
                        help='Head number in multi-head attention')